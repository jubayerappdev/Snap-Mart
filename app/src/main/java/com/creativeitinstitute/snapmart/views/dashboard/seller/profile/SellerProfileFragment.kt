...
import com.creativeitinstitute.snapmart.databinding.FragmentSellerProfileBinding
...
class SellerProfileFragment : BaseFragment<FragmentSellerProfileBinding>(
    ...
    private var hashLocalImage : Boolean = false
    ...
    fun updateProfile(sellerProfile: Profile?) {
        sellerProfile?.let {
            viewModel.updateProfile(it, hashLocalImage)
        }
    ...
    private fun setProfileData (sellerProfile: Profile?){
        hashLocalImage = sellerProfile?.userImage.isNullOrBlank()
